...
**Planned Updates**
* KG-Phone support to make payments
...
**[PolyZone](https://github.com/kgcore-framework/PolyZone)**
...
```lua
Config = {}
Config.UsingTarget = false -- If you are using kg-target (uses entity zones to target vehicles)
